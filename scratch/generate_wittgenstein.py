...
def main():
    spritesheet_path = "/Users/svennatterer/.gemini/antigravity/brain/3b0044cb-d265-434a-a4c3-e1de411c39b9/media__1779889102279.jpg"
    if not os.path.exists(spritesheet_path):
        print(f"Error: Wittgenstein source image not found at {spritesheet_path}")
        return
    ...
    print("\n--- Processing Ludwig Wittgenstein ---")
    wittgenstein_frames = extract_and_clean_cells(img)
    generate_portrait(wittgenstein_frames[0], "images/Wittgenstein.png")
    generate_spritesheet(wittgenstein_frames, "images/Wittgenstein_idle_strip.png")
    generate_preview_gif(
        "images/Wittgenstein_idle_strip.png",
        "/Users/svennatterer/.gemini/antigravity/brain/3b0044cb-d265-434a-a4c3-e1de411c39b9/Wittgenstein.gif"
    )
