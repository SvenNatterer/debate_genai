...
def remove_connected_checkerboard_background(cell):
    ...
    # The Kant sheet uses a grey checkerboard. Treat only near-neutral pixels as
    # removable background so the grey hair and facial detail are preserved.
    bg_candidate = (
...
def main():
    spritesheet_path = "/Users/svennatterer/.gemini/antigravity/brain/5972121d-a60c-4a9b-8aa1-59a16a901012/media__1779874741386.png"
    if not os.path.exists(spritesheet_path):
        print(f"Error: Kant source image not found at {spritesheet_path}")
        return
    ...
    print("\n--- Processing Immanuel Kant ---")
    kant_frames = extract_and_clean_cells(img)
    generate_portrait(kant_frames[0], "images/Kant.png")
    generate_spritesheet(kant_frames, "images/Kant_idle_strip.png")
    generate_preview_gif(
        "images/Kant_idle_strip.png",
        "/Users/svennatterer/.gemini/antigravity/brain/5972121d-a60c-4a9b-8aa1-59a16a901012/Kant.gif"
    )
