...
def extract_and_clean_cells(img, start_y):
    cells = []
    boundaries = [0, 134, 269, 403, 537, 670]
    for col in range(5):
        x1 = boundaries[col]
        x2 = boundaries[col + 1]
        y1 = start_y
...
def main():
    spritesheet_path = "/Users/svennatterer/.gemini/antigravity/brain/5972121d-a60c-4a9b-8aa1-59a16a901012/media__1779871123672.png"
    if not os.path.exists(spritesheet_path):
        print(f"Error: Hypatia source image not found at {spritesheet_path}")
        return
    ...
    hypatia_frames = extract_and_clean_cells(img, 190)
    generate_portrait(hypatia_frames[0], "images/Hypatia.png")
    generate_spritesheet(hypatia_frames, "images/Hypatia_idle_strip.png")
