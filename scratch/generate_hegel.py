...
IDLE_Y1 = 54
IDLE_Y2 = 175
BACKGROUND_SATURATION_LIMIT = 10
...
def remove_connected_checkerboard_background(cell):
    ...
    # Hegel's source is a JPEG checkerboard, so the neutral background has
    # compression noise. Use a modest tolerance, then flood-fill from borders
    # so neutral highlights inside the sprite are not deleted.
    bg_candidate = (
...
def main():
    spritesheet_path = "/Users/svennatterer/.gemini/antigravity/brain/5972121d-a60c-4a9b-8aa1-59a16a901012/media__1779874741384.jpg"
    if not os.path.exists(spritesheet_path):
        print(f"Error: Hegel source image not found at {spritesheet_path}")
        return
    ...
    print("\n--- Processing Georg Wilhelm Friedrich Hegel ---")
    hegel_frames = extract_and_clean_cells(img)
    generate_portrait(hegel_frames[0], "images/Hegel.png")
    generate_spritesheet(hegel_frames, "images/Hegel_idle_strip.png")
    generate_preview_gif(
        "images/Hegel_idle_strip.png",
        "/Users/svennatterer/.gemini/antigravity/brain/5972121d-a60c-4a9b-8aa1-59a16a901012/Hegel.gif"
    )
