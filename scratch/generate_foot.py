...
def main():
    spritesheet_path = "/Users/svennatterer/.gemini/antigravity/brain/3b0044cb-d265-434a-a4c3-e1de411c39b9/media__1779889098701.jpg"
    if not os.path.exists(spritesheet_path):
        print(f"Error: Foot source image not found at {spritesheet_path}")
        return
    ...
    print("\n--- Processing Philippa Foot ---")
    foot_frames = extract_and_clean_cells(img)
    generate_portrait(foot_frames[0], "images/Foot.png")
    generate_spritesheet(foot_frames, "images/Foot_idle_strip.png")
    generate_preview_gif(
        "images/Foot_idle_strip.png",
        "/Users/svennatterer/.gemini/antigravity/brain/3b0044cb-d265-434a-a4c3-e1de411c39b9/Foot.gif"
    )
