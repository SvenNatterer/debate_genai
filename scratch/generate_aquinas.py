...
def extract_and_clean_cells(img, start_y):
    cells = []
    boundaries = [0, 135, 270, 406, 541, 675]
    for col in range(5):
        x1 = boundaries[col]
        x2 = boundaries[col + 1]
        y1 = start_y
...
def main():
    spritesheet_path = "/Users/svennatterer/.gemini/antigravity/brain/5972121d-a60c-4a9b-8aa1-59a16a901012/media__1779871381102.png"
    if not os.path.exists(spritesheet_path):
        print(f"Error: Aquinas source image not found at {spritesheet_path}")
        return
    ...
    print("\n--- Processing Thomas Aquinas ---")
    # Sprites start at Y = 190 (Row 2, since Row 1 is empty green cells)
    aquinas_frames = extract_and_clean_cells(img, 190)
    generate_portrait(aquinas_frames[0], "images/Aquinas.png")
    generate_spritesheet(aquinas_frames, "images/Aquinas_idle_strip.png")
