...
def extract_and_clean_cells(img, start_y):
    cells = []
    boundaries = [0, 131, 262, 393, 524, 655]
    for col in range(5):
        x1 = boundaries[col]
        x2 = boundaries[col + 1]
        y1 = start_y
...
def main():
    spritesheet_path = "/Users/svennatterer/.gemini/antigravity/brain/5972121d-a60c-4a9b-8aa1-59a16a901012/media__1779874283572.png"
    if not os.path.exists(spritesheet_path):
        print(f"Error: Descartes source image not found at {spritesheet_path}")
        return
    ...
    print("\n--- Processing René Descartes ---")
    descartes_frames = extract_and_clean_cells(img, 57)
    generate_portrait(descartes_frames[0], "images/Descartes.png")
    generate_spritesheet(descartes_frames, "images/Descartes_idle_strip.png")
